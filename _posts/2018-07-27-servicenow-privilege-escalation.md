---
title: ServiceNow Glide scripting injection leading to privilege escalation
...
Details:
  ...
  vulnerability.  It is possible to injection glide code (scripting language) by
  injecting a string in the format '${xyz}' in the sysparm_media parameter. To
  ...
  available permissions. A lot of different things can be done by injection Glide
  code.
